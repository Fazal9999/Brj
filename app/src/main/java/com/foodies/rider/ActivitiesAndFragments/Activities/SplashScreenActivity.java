...
import com.foodies.rider.BuildConfig;
import com.foodies.rider.GoogleMapWork.MapsActivity;
...
public class SplashScreenActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener,GoogleApiClient.ConnectionCallbacks {
    ...
    public void Move_next(){
        ...
        if (!getLoINSession) {
            Intent i = new Intent(SplashScreenActivity.this, LoginAcitvity.class);
            startActivity(i);
            finish();
        }
        else {
            ...
            if (getUserType.equalsIgnoreCase("rider")) {
                ...
                Intent i = new Intent(SplashScreenActivity.this, RiderMainActivity.class);
                startActivity(i);
                finish();
