package com.foodies.rider.ActivitiesAndFragments.Activities;
...
public class LoginAcitvity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        log_in_now.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String valid = ed_email.getText().toString();

                if (ed_email.getText().toString().trim().equals("")) {

                    Toast.makeText(LoginAcitvity.this, "Enter Usrname/Email!", Toast.LENGTH_SHORT).show();
    ...
    private void login(String email,String pass){
        ...
        try {
            ...
            if(_lat.isEmpty()){
                jsonObject.put("lat", "25.185056");
            }else {
                jsonObject.put("lat", _lat);
            }
            if(_long.isEmpty()){
                jsonObject.put("long", "55.3485409");
            }else {
