...
import com.foodies.rider.Constants.AllConstants;
import com.foodies.rider.Constants.ApiRequest;
import com.foodies.rider.Constants.Callback;
import com.foodies.rider.Constants.Config;
import com.foodies.rider.Constants.PreferenceClass;
import com.foodies.rider.Utils.FontHelper;
                ...
                try {
                    ...
                    if(code_id == 200) {
                        ...
                        for (int i=0;i<jsonArray.length();i++) {
                            ...
                            user_address.setText(street_user + ", " + country_user);
                            ...
                            if (getPaymentMethodTV.equalsIgnoreCase("0")) {
                                ...
                                total_payment_tv.setText(currency_symbol+" "+price);
                                Log.d("ADebugTag", "In else");
                            }

                            JSONObject restaurantAddress = restaurantJsonObject.getJSONObject("RestaurantLocation");
                            Log.d("ADebugTag", "Adrss: " + restaurantAddress);
                            Log.d("ADebugTag", "after adress");
                            ...
                            rest_address_tv.setText(city);

                            hotel_address_tv.setText(city);
